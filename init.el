...
(use-package lsp-mode
  ...
  (setq lsp-keymap-prefix "C-x")
  (define-key lsp-mode-map (kbd "C-x") lsp-command-map)
  ...
  (define-key lsp-mode-map (kbd "C-x h t") #'lsp-treemacs-type-hierarchy)
  (define-key lsp-mode-map (kbd "C-x h c") #'lsp-treemacs-call-hierarchy)
  ;; (define-key lsp-mode-map (kbd "C-x h c") #'lsp-treemacs-hierarchy)
  :hook (lsp-mode . (lambda ()
                      (let ((lsp-keymap-prefix "C-x"))
