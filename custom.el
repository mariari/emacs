(custom-set-variables
 ...
 '(ansi-color-names-vector
   ["#504545" "#ad8572" "#a9df90" "#aaca86" "#91a0b3" "#ab85a3" "#afcfef"
    "#bdbdb3"])
 '(ansi-term-color-vector
   [unspecified "#3f3f3f" "#dca3a3" "#5f7f5f" "#e0cf9f" "#7cb8bb"
                "#dc8cc3" "#7cb8bb" "#dcdccc"] t)
 '(beacon-color "#eab4484b8035")
 '(clojure-align-binding-forms
   '("let" "when-let" "when-some" "if-let" "if-some" "binding" "loop"
     "doseq" "for" "with-open" "with-local-vars" "with-redefs" "bind"))
 ...
 '(helm-boring-file-regexp-list
   '("\\.checked$" "\\.hints$" "\\.beam$" "\\.vee$" "\\.jam$" "\\.hi$"
     "\\.pho$" "\\.phi$" "\\.glob$" "\\.vo$" "\\.cmti$" "\\.cmt$"
     "\\.annot$" "\\.cmi$" "\\.cmxa$" "\\.cma$" "\\.cmx$" "\\.cmo$"
     "\\.o$" "~$" "\\.bin$" "\\.lbin$" "\\.so$" "\\.a$" "\\.ln$"
     "\\.blg$" "\\.bbl$" "\\.elc$" "\\.lof$" "\\.glo$" "\\.idx$"
     "\\.lot$" "\\.svn\\(/\\|$\\)" "\\.hg\\(/\\|$\\)"
     "\\.git\\(/\\|$\\)" "\\.bzr\\(/\\|$\\)" "CVS\\(/\\|$\\)"
     "_darcs\\(/\\|$\\)" "_MTN\\(/\\|$\\)" "\\.fmt$" "\\.tfm$"
     "\\.class$" "\\.fas$" "\\.lib$" "\\.mem$" "\\.x86f$" "\\.sparcf$"
     "\\.dfsl$" "\\.pfsl$" "\\.d64fsl$" "\\.p64fsl$" "\\.lx64fsl$"
     "\\.lx32fsl$" "\\.dx64fsl$" "\\.dx32fsl$" "\\.fx64fsl$"
     "\\.fx32fsl$" "\\.sx64fsl$" "\\.sx32fsl$" "\\.wx64fsl$"
     "\\.wx32fsl$" "\\.fasl$" "\\.ufsl$" "\\.fsl$" "\\.dxl$" "\\.lo$"
     "\\.la$" "\\.gmo$" "\\.mo$" "\\.toc$" "\\.aux$" "\\.cp$" "\\.fn$"
     "\\.ky$" "\\.pg$" "\\.tp$" "\\.vr$" "\\.cps$" "\\.fns$" "\\.kys$"
     "\\.pgs$" "\\.tps$" "\\.vrs$" "\\.pyc$" "\\.pyo$"))
 ...
 '(nyan-wavy-trail t)
 '(org-agenda-files
   '("~/Notes/notes.org" "~/Notes/Cooking.org"
     "~/Documents/Notes/Org Notes/Misc/Research/articles.org"))
 '(org-pretty-entities t)
 '(org-startup-indented t)
 '(package-selected-packages
   '(dired-ranger ranger zenburn-theme erc-colorize erc-hl-nicks
                  erc-image erc-yt eldoc scheme-complete geiser-racket
                  geiser-chez ac-geiser geiser geiser-mit
                  macrostep-geiser gemini-mode bnf-mode fuel poporg
                  racket-mode edit-indirect hledger-mode ledger-mode
                  transient ivy company-ledger use-package esup vterm
                  popwin tuareg xah-math-input undo-tree smartparens
                  sly-macrostep sly-asdf rainbow-mode
                  rainbow-delimiters nyan-mode merlin-eldoc magit
                  lsp-ui lsp-haskell lispy linum-relative
                  iy-go-to-char highlight-parentheses helm-company
                  flycheck evil company-coq))
   ...
   '((put 'our-let* 'scheme-indent-function 1)
     ...
     (eval cl-flet
           ...
           (enhance-imenu-lisp "bookmarklet-command" "class" "command"
                               "ffi-method" "function" "mode"
                               "parenscript" "user-class"))
     (Base . 10) (Syntax . Common-Lisp) (Package . Maxima)
     (eval cl-flet
           ((enhance-imenu-lisp (&rest keywords)
                                (dolist (keyword keywords)
                                  (add-to-list
